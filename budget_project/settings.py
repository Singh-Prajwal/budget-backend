...
SECRET_KEY = 'django-insecure-v3+x8z=lzn%*-jyc-b6uh*4)ngqqe6xq5n31r5fv2nb=_u%+nu'
...
INSTALLED_APPS = [
    ...
    # Local Apps
    'users.apps.UsersConfig', # Add the new users app (place it before core)
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True, # For added security, a new refresh token is issued on each refresh
...
#     # This is the production environment (on Render)
#     DATABASES = {
