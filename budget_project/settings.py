...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-v3+x8z=lzn%*-jyc-b6uh*4)ngqqe6xq5n31r5fv2nb=_u%+nu')
...
ALLOWED_HOSTS = [
    'budget-tracker-0448.onrender.com',
    '127.0.0.1',
    'localhost',
    '0.0.0.0',
    '.replit.dev',
...
# Add Replit-specific host from environment if available
if os.getenv('REPL_SLUG') and os.getenv('REPL_OWNER'):
    REPLIT_HOST = os.getenv('REPL_SLUG') + '.' + os.getenv('REPL_OWNER') + '.repl.co'
